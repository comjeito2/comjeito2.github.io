...
var _comjeito$comjeito$Types$Model = F2(
	function (a, b) {
		return {currentPage: a, mdl: b};
	});
...
var _comjeito$comjeito$Model$model = {mdl: _debois$elm_mdl$Material$model, currentPage: _comjeito$comjeito$Types$Home};
